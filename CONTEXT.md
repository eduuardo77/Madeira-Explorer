...
| ~~OD-4~~ | Monetisation | **RESOLVED 2026-08-17 → D-072, revised 2026-09-25 → D-089** | **Free on Play.** The map of where you have been, the recorder and trips free forever, unlimited; **5 stamps + your first levada free**; **one purchase of €5.99** unlocks all of Madeira forever, plus **set medals** and a **founder stamp** for buyers in the first 3 months; earned stamps always kept (locked, D-075). The exported video (v1.1) is free with a medium mark and an end card, a small mark and no end card when paid. Break-even **$25**. ⚠ One-way on Android; the allowance can only rise after release. No ads, no subscription (ruled out for now, reopened only by a new decision); print-on-demand deferred. |
