...
| OD-4 | Monetisation | **Researched 2026-08-17** — `docs/monetization-options.md` | **Awaiting the project lead.** Break-even is **$25**; recommendation is **paid up front, €4.99, Android first, no IAP** (D-072). No ads ever. |
