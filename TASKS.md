...
- [ ] **T-187** **The project lead's own actions:** a domain to host the privacy policy, and
      ...
      attorney's view on EUTM 006378988, and whether to register Bruma (EUIPO or INPI, D-092); the upload key (T-117e). **Start them on day one**: each is small, but they
