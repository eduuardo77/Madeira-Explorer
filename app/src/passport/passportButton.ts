 ...
 * stamp itself is ~70 dp, the size the project lead approved in the drawn
 * options. Here rather than in `PrimaryOverlay.tsx` so the preview draws the
 * same size.
 */
export const STAMP_BUTTON_SIZE = 84;
